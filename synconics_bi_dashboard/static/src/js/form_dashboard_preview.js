    ...
    useEffect(
      () => {
        ...
        let prepared_data = {
          ...
          // ── Tile group_by ──
          tile_group_by_id: this.props.record.data.tile_group_by_id
            ? this.props.record.data.tile_group_by_id[0]
            : false,
          tile_group_mode: this.props.record.data.tile_group_mode,
          tile_group_limit: this.props.record.data.tile_group_limit,
          // ── Multi-dim V0 ──
          dim1_link_field_id: this.props.record.data.dim1_link_field_id
            ? this.props.record.data.dim1_link_field_id[0]
            : false,
          dim1_group_field_id: this.props.record.data.dim1_group_field_id
            ? this.props.record.data.dim1_group_field_id[0]
            : false,
          enable_dim2: this.props.record.data.enable_dim2,
          dim2_link_field_id: this.props.record.data.dim2_link_field_id
            ? this.props.record.data.dim2_link_field_id[0]
            : false,
          dim2_group_field_id: this.props.record.data.dim2_group_field_id
            ? this.props.record.data.dim2_group_field_id[0]
            : false,
          dim2_time_granularity: this.props.record.data.dim2_time_granularity,
        };
