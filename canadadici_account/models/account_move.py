...
class AccountMove(models.Model):
    ...
    # invoice_time = fields.Char(string="Heure de livraison", size=6, index=True, help="Saisir l'heure et les minutes au format HH:MM")
    invoice_time = fields.Datetime(
        string="Heure de livraison", 
        index=True, help="Saisir l'heure et les minutes au format HH:MM"
        )
